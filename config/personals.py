...
# Your legal name
first_name = "Ateeb"                 # Your first name in quotes Eg: "First", "Sai"
middle_name = "Ahmad"            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Ansari"                # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "0320-4859577"        # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city?
current_city = "Lahore"                  # Los Angeles, San Francisco, etc.
'''
